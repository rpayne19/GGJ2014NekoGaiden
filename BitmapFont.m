...
- (void)parseCommon:(NSString*)line {
    ...
    NSAssert(scaleW <= 1024, @"ERROR - BitmapFont: Tilemap Texture cannot be larger than 1024x1024");
    // scaleH is the height of the texture atlas for this font.
    NSAssert(scaleH <= 1024, @"ERROR - BitmapFont: Tilemap Texture cannot be larger than 1024x1024");
