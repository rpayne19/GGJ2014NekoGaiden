...
#define MAXIMUM_FRAME_RATE 30.0f		// Must also be set in ParticleEmitter.m
...
- (void) startAnimation
{
	if (!animating)
	{
		if (displayLinkSupported)
		{
			...
			animationTimer = [NSTimer scheduledTimerWithTimeInterval:(NSTimeInterval)((1.0f / MAXIMUM_FRAME_RATE) * animationFrameInterval) target:self selector:@selector(gameLoop) userInfo:nil repeats:TRUE];
